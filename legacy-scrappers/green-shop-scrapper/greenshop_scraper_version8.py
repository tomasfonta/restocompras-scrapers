...
def write_to_excel_file(data, filename):
    ...
    try:
        ...
        # PASO CRÍTICO: Eliminar filas duplicadas
        ...
        print(f"\n✅ Extracción y estandarización completada.")
        print(f"   Filas duplicadas encontradas y eliminadas: {duplicates_removed}")
...
if __name__ == "__main__":
    print(f"Iniciando raspado de {len(URLS)} categorías y preparación de datos...")
